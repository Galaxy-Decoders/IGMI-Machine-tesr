...
extension UIView {
    ...
    func createDottedHorizontalLine(color: CGColor, height: CGFloat) {
        let lineLayer = CAShapeLayer()
        lineLayer.strokeColor = UIColor.App_E0E0E0_Color.cgColor
        lineLayer.lineWidth = 2
        lineLayer.lineCap = .round
        lineLayer.lineDashPattern = [4,4]
        //        let path = CGMutablePath()
        //        path.addLines(between: [CGPoint(x: 38, y: 0),
        //                                CGPoint(x: 38, y: height)])
        //        lineLayer.path = path
        
        let cgPath = CGMutablePath()
        let cgPoint = [CGPoint(x: 38, y: 0), CGPoint(x: 38, y: height)]
        cgPath.addLines(between: cgPoint)
...
extension UIColor {
    static let App_Orange_Color =  UIColor(named: "Orange")!
    static let App_E0E0E0_Color = UIColor(named: "E0E0E0")!
    static let App_DarkGray_Color = UIColor(named: "DarkGray")!
}
